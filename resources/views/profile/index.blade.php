            ...
            <div class="row">
                <div class="headline col-md-10 mx-auto">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <p class="gender mx-auto">{{ str_limit($headline->gender, 65) }}</p>
                        </div>
                        <div class="col-md-2">
                            <p class="hobby mx-auto">{{ str_limit($headline->hobby, 65) }}</p>
                        </div>
                        <div class="col-md-2">
                            <p class="introduction mx-auto">{{ str_limit($headline->introduction, 65) }}</p>
                        </div>
                    </div>
                </div>
            </div>
